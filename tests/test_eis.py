...
# tests/fixtures/olap_grid.json (Task 6, 실뷰어 캡처, (지역별)시도 축) 로 검증한다
# — 컨트롤러가 준 검증값(2026년 07월)과 정확히 일치해야 한다.
# ---------------------------------------------------------------------------
...
def test_collect_vacancy_sido_matches_verified_totals():
    ...
    assert by_sido["11"]["vacancy"] == 29196 and by_sido["11"]["seekers"] == 268616
    assert by_sido["41"]["vacancy"] == 45743 and by_sido["41"]["seekers"] == 407355
    assert by_sido["28"]["vacancy"] == 7501 and by_sido["28"]["seekers"] == 99637
